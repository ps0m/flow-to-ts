            ...
            >
                ...
                <div style={tabContainerStyle}>
                    <div
                        style={{
                            ...tabStyle,
                            color: this.state.focusedEditor === this.flowEditor ? 'black' : '#777',
                        }}
                    >
                        input.js
                    </div>
                ...
                <div style={tabContainerStyle}>
                    <div
                        style={{
                            ...tabStyle,
                            color: this.state.focusedEditor === this.tsEditor ? 'black' : '#777',
                        }}
                    >
                        output.ts [readonly]
                    </div>
                ...
                >
                    <CodeMirror
                        ...
                        onFocus={(editor, event) => this.setState({ focusedEditor: editor })}
