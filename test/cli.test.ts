...
describe('cli', () => {
    ...
    it('should write a file', () => {
        ...
        // Act
        cli(['node', path.join(__dirname, '../flow-to-ts.js'), '--write', inputPath]);
    ...
    it('should write many files with a glob', () => {
        ...
        fs.writeFileSync(path.join(tmpdir, 'foo.js'), 'const a: number = 5;', 'utf-8');
        fs.writeFileSync(path.join(tmpdir, 'bar.js'), 'const b: boolean = true;', 'utf-8');

        // Act
        cli(['node', path.join(__dirname, '../flow-to-ts.js'), '--write', inputGlob]);
    ...
    it('should convert jsx to tsx and delete many original files', () => {
        ...
        fs.writeFileSync(path.join(tmpdir, 'baz.jsx'), 'const c: boolean = false;', 'utf-8');
    ...
    it('should attempt to load the prettier config file', () => {
        ...
        // Act
        cli(['node', path.join(__dirname, '../flow-to-ts.js'), '--prettier', inputPath]);
